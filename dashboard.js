...
const MASTER_OPD_LIST = [
    ...
    { id: 'DPMP2T', nama: 'Dinas Penanaman Modal dan Pelayanan Perizinan Terpadu (DPMP2T)', kategori: 'DINAS' },
    ...
    { id: 'DISBUNNAK', nama: 'Dinas Perkebunan dan Peternakan', kategori: 'DINAS' },
    ...
    { id: 'DISTANTPH', nama: 'Dinas Tanaman Pangan dan Hortikultura', kategori: 'DINAS' },
    { id: 'DKPP', nama: 'Dinas Ketahanan Pangan dan Penyuluhan', kategori: 'DINAS' },
    { id: 'DISPERINNAKERTRANS', nama: 'Dinas Perindustrian, Tenaga Kerja dan Transmigrasi', kategori: 'DINAS' },
    ...
    { id: 'KEC_DARUL_IHSAN', nama: 'Kecamatan Darul Ihsan', kategori: 'KECAMATAN' },
    ...
    { id: 'KEC_INDRA_MAKMU', nama: 'Kecamatan Indra Makmu', kategori: 'KECAMATAN' },
    { id: 'KEC_JULOK', nama: 'Kecamatan Julok', kategori: 'KECAMATAN' },
    { id: 'KEC_MADAT', nama: 'Kecamatan Madat', kategori: 'KECAMATAN' },
    ...
    { id: 'SET_MPA', nama: 'Sekretariat Majelis Pendidikan Aceh (MPA)', kategori: 'DINAS' },
...
function downloadTemplateFile(type) {
    ...
    if (type === 'rekap') {
        headers = ["Unit Organisasi / SKPD", "Bulan", "Tahun", "PNS", "PPPK", "PPPK PW", "Sangat Baik", "Baik", "Butuh Perbaikan", "Kurang", "Sangat Kurang", "Tidak membuat SKP"];
        mockRows = [
        ...
        filename = 'Template_Data_SKP_Kinerja_SKPD_Kab_Aceh_Timur.xlsx';
    } else {
        headers = ["NIP", "Nama", "Status Pegawai", "Unit Kerja / SKPD", "Predikat Kinerja", "Bulan", "Tahun"];
        mockRows = [
        ...
        filename = 'Template_Detail_Pegawai_SKP_Kinerja_SKPD_Kab_Aceh_Timur.xlsx';
    }

    const wsData = [headers, ...mockRows];
    const ws = XLSX.utils.aoa_to_sheet(wsData);
    const wb = XLSX.utils.book_new();
    XLSX.utils.book_append_sheet(wb, ws, "Template SKPD");
